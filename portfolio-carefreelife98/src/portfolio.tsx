...
export const skills = {
	...
	lists: [
		...
		{fontAwesome: "fab python", text: "Python", proficiency: 80},
		{fontAwesome: "fab js", text: "JS", proficiency: 40},
		...
		{fontAwesome: "fab git", text: "Git", proficiency: 70},
		{fontAwesome: "fab bitbucket", text: "Bitbucket", proficiency: 70},
